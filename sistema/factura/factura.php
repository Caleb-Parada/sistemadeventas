...
<div id="page_pdf">
	<table id="factura_head">
		<tr>
			<td class="logo_factura">
				<div>
					<img src="img/logo.png" id="imagen_empresa">
				</div>
			</td>
			...
			<td class="info_cliente">
				<div class="round">
					...
					<table class="datos_cliente">
						<tr>
							<td><label>Identificación:</label><p><?php echo $factura['dni']; ?></p></td>
	...
	<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">
				...
				<tr>
					<td colspan="3" class="textright"><span>IVA (<?php echo round($iva,0); ?>%)</span></td>
