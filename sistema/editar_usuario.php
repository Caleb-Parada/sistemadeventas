<?php 
	...
	if(!empty($_POST))
	{
		...
		if(empty($_POST['nombre']) || empty($_POST['correo']) || empty($_POST['usuario'])  || empty($_POST['rol']))
		{
			...
			$query = mysqli_query($obj_conexion,"SELECT * FROM usuario 
			...
			if($result > 0){
				...
				if(empty($_POST['clave']))
				{
					...
					$sql_update = mysqli_query($obj_conexion,"UPDATE usuario
	...
	$sql= mysqli_query($obj_conexion,"SELECT u.idusuario, u.nombre,u.correo,u.usuario, (u.rol) as idrol, (r.rol) as rol
									FROM usuario u
									INNER JOIN rol r
									on u.rol = r.idrol
...
<body>
	...
	<section id="container">
		...
		<div class="form_register">
			<h1><i class="fas fa-edit fa-2x"></i> Actualizar usuario</h1>
			<hr>
